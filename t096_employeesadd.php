...
ft096_employeesadd.lists["x_UserLevel"] = <?php echo $t096_employees_add->UserLevel->Lookup->toClientList() ?>;
ft096_employeesadd.lists["x_UserLevel"].options = <?php echo JsonEncode($t096_employees_add->UserLevel->lookupOptions()) ?>;
