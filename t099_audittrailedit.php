...
// Create page object
$t099_audittrail_edit = new t099_audittrail_edit();

// Run the page
$t099_audittrail_edit->run();
...
$t099_audittrail_edit->Page_Render();
?>
...
var ft099_audittrailedit = currentForm = new ew.Form("ft099_audittrailedit", "edit");

// Validate form
ft099_audittrailedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($t099_audittrail_edit->id->Required) { ?>
			elm = this.getElements("x" + infix + "_id");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $t099_audittrail->id->caption(), $t099_audittrail->id->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($t099_audittrail_edit->datetime->Required) { ?>
		...
		<?php if ($t099_audittrail_edit->script->Required) { ?>
		...
		<?php } ?>
		<?php if ($t099_audittrail_edit->user->Required) { ?>
		...
		<?php } ?>
		<?php if ($t099_audittrail_edit->_action->Required) { ?>
		...
		<?php } ?>
		<?php if ($t099_audittrail_edit->_table->Required) { ?>
		...
		<?php } ?>
		<?php if ($t099_audittrail_edit->field->Required) { ?>
		...
		<?php } ?>
		<?php if ($t099_audittrail_edit->keyvalue->Required) { ?>
		...
		<?php } ?>
		<?php if ($t099_audittrail_edit->oldvalue->Required) { ?>
		...
		<?php } ?>
		<?php if ($t099_audittrail_edit->newvalue->Required) { ?>
...
ft099_audittrailedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
ft099_audittrailedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $t099_audittrail_edit->showPageHeader(); ?>
<?php
$t099_audittrail_edit->showMessage();
?>
<form name="ft099_audittrailedit" id="ft099_audittrailedit" class="<?php echo $t099_audittrail_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($t099_audittrail_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $t099_audittrail_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t099_audittrail">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$t099_audittrail_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($t099_audittrail->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_t099_audittrail_id" class="<?php echo $t099_audittrail_edit->LeftColumnClass ?>"><?php echo $t099_audittrail->id->caption() ?><?php echo ($t099_audittrail->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t099_audittrail_edit->RightColumnClass ?>"><div<?php echo $t099_audittrail->id->cellAttributes() ?>>
<span id="el_t099_audittrail_id">
<span<?php echo $t099_audittrail->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($t099_audittrail->id->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="t099_audittrail" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($t099_audittrail->id->CurrentValue) ?>">
<?php echo $t099_audittrail->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($t099_audittrail->datetime->Visible) { // datetime ?>
	<div id="r_datetime" class="form-group row">
		<label id="elh_t099_audittrail_datetime" for="x_datetime" class="<?php echo $t099_audittrail_edit->LeftColumnClass ?>"><?php echo $t099_audittrail->datetime->caption() ?><?php echo ($t099_audittrail->datetime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t099_audittrail_edit->RightColumnClass ?>"><div<?php echo $t099_audittrail->datetime->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("ft099_audittrailedit", "x_datetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($t099_audittrail->script->Visible) { // script ?>
	<div id="r_script" class="form-group row">
		<label id="elh_t099_audittrail_script" for="x_script" class="<?php echo $t099_audittrail_edit->LeftColumnClass ?>"><?php echo $t099_audittrail->script->caption() ?><?php echo ($t099_audittrail->script->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t099_audittrail_edit->RightColumnClass ?>"><div<?php echo $t099_audittrail->script->cellAttributes() ?>>
...
<?php if ($t099_audittrail->user->Visible) { // user ?>
	<div id="r_user" class="form-group row">
		<label id="elh_t099_audittrail_user" for="x_user" class="<?php echo $t099_audittrail_edit->LeftColumnClass ?>"><?php echo $t099_audittrail->user->caption() ?><?php echo ($t099_audittrail->user->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t099_audittrail_edit->RightColumnClass ?>"><div<?php echo $t099_audittrail->user->cellAttributes() ?>>
...
<?php if ($t099_audittrail->_action->Visible) { // action ?>
	<div id="r__action" class="form-group row">
		<label id="elh_t099_audittrail__action" for="x__action" class="<?php echo $t099_audittrail_edit->LeftColumnClass ?>"><?php echo $t099_audittrail->_action->caption() ?><?php echo ($t099_audittrail->_action->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t099_audittrail_edit->RightColumnClass ?>"><div<?php echo $t099_audittrail->_action->cellAttributes() ?>>
...
<?php if ($t099_audittrail->_table->Visible) { // table ?>
	<div id="r__table" class="form-group row">
		<label id="elh_t099_audittrail__table" for="x__table" class="<?php echo $t099_audittrail_edit->LeftColumnClass ?>"><?php echo $t099_audittrail->_table->caption() ?><?php echo ($t099_audittrail->_table->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t099_audittrail_edit->RightColumnClass ?>"><div<?php echo $t099_audittrail->_table->cellAttributes() ?>>
...
<?php if ($t099_audittrail->field->Visible) { // field ?>
	<div id="r_field" class="form-group row">
		<label id="elh_t099_audittrail_field" for="x_field" class="<?php echo $t099_audittrail_edit->LeftColumnClass ?>"><?php echo $t099_audittrail->field->caption() ?><?php echo ($t099_audittrail->field->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t099_audittrail_edit->RightColumnClass ?>"><div<?php echo $t099_audittrail->field->cellAttributes() ?>>
...
<?php if ($t099_audittrail->keyvalue->Visible) { // keyvalue ?>
	<div id="r_keyvalue" class="form-group row">
		<label id="elh_t099_audittrail_keyvalue" for="x_keyvalue" class="<?php echo $t099_audittrail_edit->LeftColumnClass ?>"><?php echo $t099_audittrail->keyvalue->caption() ?><?php echo ($t099_audittrail->keyvalue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t099_audittrail_edit->RightColumnClass ?>"><div<?php echo $t099_audittrail->keyvalue->cellAttributes() ?>>
...
<?php if ($t099_audittrail->oldvalue->Visible) { // oldvalue ?>
	<div id="r_oldvalue" class="form-group row">
		<label id="elh_t099_audittrail_oldvalue" for="x_oldvalue" class="<?php echo $t099_audittrail_edit->LeftColumnClass ?>"><?php echo $t099_audittrail->oldvalue->caption() ?><?php echo ($t099_audittrail->oldvalue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t099_audittrail_edit->RightColumnClass ?>"><div<?php echo $t099_audittrail->oldvalue->cellAttributes() ?>>
...
<?php if ($t099_audittrail->newvalue->Visible) { // newvalue ?>
	<div id="r_newvalue" class="form-group row">
		<label id="elh_t099_audittrail_newvalue" for="x_newvalue" class="<?php echo $t099_audittrail_edit->LeftColumnClass ?>"><?php echo $t099_audittrail->newvalue->caption() ?><?php echo ($t099_audittrail->newvalue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t099_audittrail_edit->RightColumnClass ?>"><div<?php echo $t099_audittrail->newvalue->cellAttributes() ?>>
...
<?php if (!$t099_audittrail_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $t099_audittrail_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $t099_audittrail_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$t099_audittrail_edit->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$t099_audittrail_edit->terminate();
?>