...
// Create page object
$t101_costsheethead_edit = new t101_costsheethead_edit();

// Run the page
$t101_costsheethead_edit->run();
...
$t101_costsheethead_edit->Page_Render();
?>
...
var ft101_costsheetheadedit = currentForm = new ew.Form("ft101_costsheetheadedit", "edit");

// Validate form
ft101_costsheetheadedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($t101_costsheethead_edit->liner_id->Required) { ?>
		...
		<?php } ?>
		<?php if ($t101_costsheethead_edit->no_bl->Required) { ?>
		...
		<?php } ?>
		<?php if ($t101_costsheethead_edit->shipper_id->Required) { ?>
		...
		<?php } ?>
		<?php if ($t101_costsheethead_edit->top_1->Required) { ?>
		...
		<?php } ?>
		<?php if ($t101_costsheethead_edit->vol->Required) { ?>
		...
		<?php if ($t101_costsheethead_edit->cont->Required) { ?>
		...
		<?php } ?>
		<?php if ($t101_costsheethead_edit->no_ref->Required) { ?>
		...
		<?php } ?>
		<?php if ($t101_costsheethead_edit->vsl_voy->Required) { ?>
		...
		<?php } ?>
		<?php if ($t101_costsheethead_edit->pol_pod->Required) { ?>
		...
		<?php } ?>
		<?php if ($t101_costsheethead_edit->top_2->Required) { ?>
		...
		<?php } ?>
		<?php if ($t101_costsheethead_edit->no_cont->Required) { ?>
...
ft101_costsheetheadedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
ft101_costsheetheadedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Multi-Page
ft101_costsheetheadedit.multiPage = new ew.MultiPage("ft101_costsheetheadedit");

// Dynamic selection lists
ft101_costsheetheadedit.lists["x_liner_id"] = <?php echo $t101_costsheethead_edit->liner_id->Lookup->toClientList() ?>;
ft101_costsheetheadedit.lists["x_liner_id"].options = <?php echo JsonEncode($t101_costsheethead_edit->liner_id->lookupOptions()) ?>;
ft101_costsheetheadedit.lists["x_shipper_id"] = <?php echo $t101_costsheethead_edit->shipper_id->Lookup->toClientList() ?>;
ft101_costsheetheadedit.lists["x_shipper_id"].options = <?php echo JsonEncode($t101_costsheethead_edit->shipper_id->lookupOptions()) ?>;
ft101_costsheetheadedit.lists["x_top_1"] = <?php echo $t101_costsheethead_edit->top_1->Lookup->toClientList() ?>;
ft101_costsheetheadedit.lists["x_top_1"].options = <?php echo JsonEncode($t101_costsheethead_edit->top_1->options(FALSE, TRUE)) ?>;
ft101_costsheetheadedit.lists["x_cont"] = <?php echo $t101_costsheethead_edit->cont->Lookup->toClientList() ?>;
ft101_costsheetheadedit.lists["x_cont"].options = <?php echo JsonEncode($t101_costsheethead_edit->cont->options(FALSE, TRUE)) ?>;
ft101_costsheetheadedit.lists["x_top_2"] = <?php echo $t101_costsheethead_edit->top_2->Lookup->toClientList() ?>;
ft101_costsheetheadedit.lists["x_top_2"].options = <?php echo JsonEncode($t101_costsheethead_edit->top_2->options(FALSE, TRUE)) ?>;
...
<?php $t101_costsheethead_edit->showPageHeader(); ?>
<?php
$t101_costsheethead_edit->showMessage();
?>
<form name="ft101_costsheetheadedit" id="ft101_costsheetheadedit" class="<?php echo $t101_costsheethead_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($t101_costsheethead_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $t101_costsheethead_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t101_costsheethead">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$t101_costsheethead_edit->IsModal ?>">
<div class="ew-multi-page"><!-- multi-page -->
<div class="ew-nav-tabs" id="t101_costsheethead_edit"><!-- multi-page tabs -->
...
<?php if ($t101_costsheethead->liner_id->Visible) { // liner_id ?>
	<div id="r_liner_id" class="form-group row">
		<label id="elh_t101_costsheethead_liner_id" for="x_liner_id" class="<?php echo $t101_costsheethead_edit->LeftColumnClass ?>"><?php echo $t101_costsheethead->liner_id->caption() ?><?php echo ($t101_costsheethead->liner_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t101_costsheethead_edit->RightColumnClass ?>"><div<?php echo $t101_costsheethead->liner_id->cellAttributes() ?>>
...
<?php if ($t101_costsheethead->no_bl->Visible) { // no_bl ?>
	<div id="r_no_bl" class="form-group row">
		<label id="elh_t101_costsheethead_no_bl" for="x_no_bl" class="<?php echo $t101_costsheethead_edit->LeftColumnClass ?>"><?php echo $t101_costsheethead->no_bl->caption() ?><?php echo ($t101_costsheethead->no_bl->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t101_costsheethead_edit->RightColumnClass ?>"><div<?php echo $t101_costsheethead->no_bl->cellAttributes() ?>>
...
<?php if ($t101_costsheethead->shipper_id->Visible) { // shipper_id ?>
	<div id="r_shipper_id" class="form-group row">
		<label id="elh_t101_costsheethead_shipper_id" for="x_shipper_id" class="<?php echo $t101_costsheethead_edit->LeftColumnClass ?>"><?php echo $t101_costsheethead->shipper_id->caption() ?><?php echo ($t101_costsheethead->shipper_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t101_costsheethead_edit->RightColumnClass ?>"><div<?php echo $t101_costsheethead->shipper_id->cellAttributes() ?>>
...
<?php if ($t101_costsheethead->top_1->Visible) { // top_1 ?>
	<div id="r_top_1" class="form-group row">
		<label id="elh_t101_costsheethead_top_1" class="<?php echo $t101_costsheethead_edit->LeftColumnClass ?>"><?php echo $t101_costsheethead->top_1->caption() ?><?php echo ($t101_costsheethead->top_1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t101_costsheethead_edit->RightColumnClass ?>"><div<?php echo $t101_costsheethead->top_1->cellAttributes() ?>>
...
<?php if ($t101_costsheethead->vol->Visible) { // vol ?>
	<div id="r_vol" class="form-group row">
		<label id="elh_t101_costsheethead_vol" for="x_vol" class="<?php echo $t101_costsheethead_edit->LeftColumnClass ?>"><?php echo $t101_costsheethead->vol->caption() ?><?php echo ($t101_costsheethead->vol->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t101_costsheethead_edit->RightColumnClass ?>"><div<?php echo $t101_costsheethead->vol->cellAttributes() ?>>
...
<?php if ($t101_costsheethead->cont->Visible) { // cont ?>
	<div id="r_cont" class="form-group row">
		<label id="elh_t101_costsheethead_cont" class="<?php echo $t101_costsheethead_edit->LeftColumnClass ?>"><?php echo $t101_costsheethead->cont->caption() ?><?php echo ($t101_costsheethead->cont->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t101_costsheethead_edit->RightColumnClass ?>"><div<?php echo $t101_costsheethead->cont->cellAttributes() ?>>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $t101_costsheethead_edit->MultiPages->pageStyle("2") ?>" id="tab_t101_costsheethead2"><!-- multi-page .tab-pane -->
<div class="ew-edit-div"><!-- page* -->
<?php if ($t101_costsheethead->no_ref->Visible) { // no_ref ?>
	<div id="r_no_ref" class="form-group row">
		<label id="elh_t101_costsheethead_no_ref" for="x_no_ref" class="<?php echo $t101_costsheethead_edit->LeftColumnClass ?>"><?php echo $t101_costsheethead->no_ref->caption() ?><?php echo ($t101_costsheethead->no_ref->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t101_costsheethead_edit->RightColumnClass ?>"><div<?php echo $t101_costsheethead->no_ref->cellAttributes() ?>>
...
<?php if ($t101_costsheethead->vsl_voy->Visible) { // vsl_voy ?>
	<div id="r_vsl_voy" class="form-group row">
		<label id="elh_t101_costsheethead_vsl_voy" for="x_vsl_voy" class="<?php echo $t101_costsheethead_edit->LeftColumnClass ?>"><?php echo $t101_costsheethead->vsl_voy->caption() ?><?php echo ($t101_costsheethead->vsl_voy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t101_costsheethead_edit->RightColumnClass ?>"><div<?php echo $t101_costsheethead->vsl_voy->cellAttributes() ?>>
...
<?php if ($t101_costsheethead->pol_pod->Visible) { // pol_pod ?>
	<div id="r_pol_pod" class="form-group row">
		<label id="elh_t101_costsheethead_pol_pod" for="x_pol_pod" class="<?php echo $t101_costsheethead_edit->LeftColumnClass ?>"><?php echo $t101_costsheethead->pol_pod->caption() ?><?php echo ($t101_costsheethead->pol_pod->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t101_costsheethead_edit->RightColumnClass ?>"><div<?php echo $t101_costsheethead->pol_pod->cellAttributes() ?>>
...
<?php if ($t101_costsheethead->top_2->Visible) { // top_2 ?>
	<div id="r_top_2" class="form-group row">
		<label id="elh_t101_costsheethead_top_2" class="<?php echo $t101_costsheethead_edit->LeftColumnClass ?>"><?php echo $t101_costsheethead->top_2->caption() ?><?php echo ($t101_costsheethead->top_2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t101_costsheethead_edit->RightColumnClass ?>"><div<?php echo $t101_costsheethead->top_2->cellAttributes() ?>>
...
<?php if ($t101_costsheethead->no_cont->Visible) { // no_cont ?>
	<div id="r_no_cont" class="form-group row">
		<label id="elh_t101_costsheethead_no_cont" for="x_no_cont" class="<?php echo $t101_costsheethead_edit->LeftColumnClass ?>"><?php echo $t101_costsheethead->no_cont->caption() ?><?php echo ($t101_costsheethead->no_cont->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t101_costsheethead_edit->RightColumnClass ?>"><div<?php echo $t101_costsheethead->no_cont->cellAttributes() ?>>
...
<?php } ?>
	...
	<input type="hidden" data-table="t101_costsheethead" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($t101_costsheethead->id->CurrentValue) ?>">
<?php
	if (in_array("t102_costsheetdetail", explode(",", $t101_costsheethead->getCurrentDetailTable())) && $t102_costsheetdetail->DetailEdit) {
?>
...
<?php } ?>
<?php if (!$t101_costsheethead_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $t101_costsheethead_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $t101_costsheethead_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$t101_costsheethead_edit->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$t101_costsheethead_edit->terminate();
?>