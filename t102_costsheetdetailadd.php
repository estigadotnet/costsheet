...
// Create page object
$t102_costsheetdetail_add = new t102_costsheetdetail_add();

// Run the page
$t102_costsheetdetail_add->run();
...
$t102_costsheetdetail_add->Page_Render();
?>
...
var ft102_costsheetdetailadd = currentForm = new ew.Form("ft102_costsheetdetailadd", "add");

// Validate form
ft102_costsheetdetailadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($t102_costsheetdetail_add->chargecode_id->Required) { ?>
		...
		<?php } ?>
		<?php if ($t102_costsheetdetail_add->vendor_id->Required) { ?>
		...
		<?php } ?>
		<?php if ($t102_costsheetdetail_add->ptl_amount->Required) { ?>
		...
		<?php if ($t102_costsheetdetail_add->ptl_total->Required) { ?>
		...
		<?php if ($t102_costsheetdetail_add->rfc_amount->Required) { ?>
		...
		<?php if ($t102_costsheetdetail_add->rfc_total->Required) { ?>
...
ft102_costsheetdetailadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
ft102_costsheetdetailadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
ft102_costsheetdetailadd.lists["x_chargecode_id"] = <?php echo $t102_costsheetdetail_add->chargecode_id->Lookup->toClientList() ?>;
ft102_costsheetdetailadd.lists["x_chargecode_id"].options = <?php echo JsonEncode($t102_costsheetdetail_add->chargecode_id->lookupOptions()) ?>;
ft102_costsheetdetailadd.lists["x_vendor_id"] = <?php echo $t102_costsheetdetail_add->vendor_id->Lookup->toClientList() ?>;
ft102_costsheetdetailadd.lists["x_vendor_id"].options = <?php echo JsonEncode($t102_costsheetdetail_add->vendor_id->lookupOptions()) ?>;
...
<?php $t102_costsheetdetail_add->showPageHeader(); ?>
<?php
$t102_costsheetdetail_add->showMessage();
?>
<form name="ft102_costsheetdetailadd" id="ft102_costsheetdetailadd" class="<?php echo $t102_costsheetdetail_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($t102_costsheetdetail_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $t102_costsheetdetail_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t102_costsheetdetail">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$t102_costsheetdetail_add->IsModal ?>">
...
<?php if ($t102_costsheetdetail->chargecode_id->Visible) { // chargecode_id ?>
	<div id="r_chargecode_id" class="form-group row">
		<label id="elh_t102_costsheetdetail_chargecode_id" for="x_chargecode_id" class="<?php echo $t102_costsheetdetail_add->LeftColumnClass ?>"><?php echo $t102_costsheetdetail->chargecode_id->caption() ?><?php echo ($t102_costsheetdetail->chargecode_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t102_costsheetdetail_add->RightColumnClass ?>"><div<?php echo $t102_costsheetdetail->chargecode_id->cellAttributes() ?>>
...
<?php if ($t102_costsheetdetail->vendor_id->Visible) { // vendor_id ?>
	<div id="r_vendor_id" class="form-group row">
		<label id="elh_t102_costsheetdetail_vendor_id" for="x_vendor_id" class="<?php echo $t102_costsheetdetail_add->LeftColumnClass ?>"><?php echo $t102_costsheetdetail->vendor_id->caption() ?><?php echo ($t102_costsheetdetail->vendor_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t102_costsheetdetail_add->RightColumnClass ?>"><div<?php echo $t102_costsheetdetail->vendor_id->cellAttributes() ?>>
...
<?php if ($t102_costsheetdetail->ptl_amount->Visible) { // ptl_amount ?>
	<div id="r_ptl_amount" class="form-group row">
		<label id="elh_t102_costsheetdetail_ptl_amount" for="x_ptl_amount" class="<?php echo $t102_costsheetdetail_add->LeftColumnClass ?>"><?php echo $t102_costsheetdetail->ptl_amount->caption() ?><?php echo ($t102_costsheetdetail->ptl_amount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t102_costsheetdetail_add->RightColumnClass ?>"><div<?php echo $t102_costsheetdetail->ptl_amount->cellAttributes() ?>>
...
<?php if ($t102_costsheetdetail->ptl_total->Visible) { // ptl_total ?>
	<div id="r_ptl_total" class="form-group row">
		<label id="elh_t102_costsheetdetail_ptl_total" for="x_ptl_total" class="<?php echo $t102_costsheetdetail_add->LeftColumnClass ?>"><?php echo $t102_costsheetdetail->ptl_total->caption() ?><?php echo ($t102_costsheetdetail->ptl_total->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t102_costsheetdetail_add->RightColumnClass ?>"><div<?php echo $t102_costsheetdetail->ptl_total->cellAttributes() ?>>
...
<?php if ($t102_costsheetdetail->rfc_amount->Visible) { // rfc_amount ?>
	<div id="r_rfc_amount" class="form-group row">
		<label id="elh_t102_costsheetdetail_rfc_amount" for="x_rfc_amount" class="<?php echo $t102_costsheetdetail_add->LeftColumnClass ?>"><?php echo $t102_costsheetdetail->rfc_amount->caption() ?><?php echo ($t102_costsheetdetail->rfc_amount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t102_costsheetdetail_add->RightColumnClass ?>"><div<?php echo $t102_costsheetdetail->rfc_amount->cellAttributes() ?>>
...
<?php if ($t102_costsheetdetail->rfc_total->Visible) { // rfc_total ?>
	<div id="r_rfc_total" class="form-group row">
		<label id="elh_t102_costsheetdetail_rfc_total" for="x_rfc_total" class="<?php echo $t102_costsheetdetail_add->LeftColumnClass ?>"><?php echo $t102_costsheetdetail->rfc_total->caption() ?><?php echo ($t102_costsheetdetail->rfc_total->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t102_costsheetdetail_add->RightColumnClass ?>"><div<?php echo $t102_costsheetdetail->rfc_total->cellAttributes() ?>>
...
<?php } ?>
	...
	<?php if (strval($t102_costsheetdetail->costsheethead_id->getSessionValue()) <> "") { ?>
	<input type="hidden" name="x_costsheethead_id" id="x_costsheethead_id" value="<?php echo HtmlEncode(strval($t102_costsheetdetail->costsheethead_id->getSessionValue())) ?>">
	<?php } ?>
<?php if (!$t102_costsheetdetail_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $t102_costsheetdetail_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $t102_costsheetdetail_add->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$t102_costsheetdetail_add->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$t102_costsheetdetail_add->terminate();
?>