...
define(PROJECT_NAMESPACE . "PROJECT_NAME", "costsheet_prj"); // Project name
define(PROJECT_NAMESPACE . "CONFIG_FILE_FOLDER", PROJECT_NAME); // Config file name
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'dWVtozwbjrIXtM4O'); // Random key for encryption
define(PROJECT_NAMESPACE . "ENCRYPTION_KEY", ''); // Encryption key for data protection
define(PROJECT_NAMESPACE . "PROJECT_STYLESHEET_FILENAME", "phpcss/costsheet_prj.css"); // Project stylesheet file name
...
$PROJECT_ID = "{21082F44-1044-49E8-8088-092C72267B54}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3307, "user" => "root", "pass" => "admin", "db" => "db_costsheet", "qs" => "`", "qe" => "`");
...
define(PROJECT_NAMESPACE . "AUDIT_TRAIL_TABLE_NAME", "t099_audittrail"); // Audit trail table name
define(PROJECT_NAMESPACE . "AUDIT_TRAIL_TABLE_VAR", "t099_audittrail"); // Audit trail table var
...
define(PROJECT_NAMESPACE . "USER_LEVEL_TABLE", "`t097_userlevels`");
...
define(PROJECT_NAMESPACE . "USER_LEVEL_PRIV_TABLE", "`t098_userlevelpermissions`");
...
define(PROJECT_NAMESPACE . "USER_TABLE_NAME", "t096_employees");
...
define(PROJECT_NAMESPACE . "USER_TABLE", "`t096_employees`");
