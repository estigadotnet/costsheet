 ...
 * Page class
 */
class t003_chargecode_view extends t003_chargecode
{
	...
	// Page object name
	public $PageObjName = "t003_chargecode_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "t003_chargecodelist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t003_chargecodelist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t003_chargecodelist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
