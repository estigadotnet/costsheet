 ...
 * Page class
 */
class t004_vendor_view extends t004_vendor
{
	...
	// Page object name
	public $PageObjName = "t004_vendor_view";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			if (!$Security->canView()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("t004_vendorlist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "t004_vendorlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t004_vendorlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t004_vendorlist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("t004_vendorlist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
