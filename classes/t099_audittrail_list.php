 ...
 * Page class
 */
class t099_audittrail_list extends t099_audittrail
{
	...
	// Table name
	public $TableName = 't099_audittrail';

	// Page object name
	public $PageObjName = "t099_audittrail_list";

	// Grid form hidden field names
	public $FormName = "ft099_audittraillist";
	...
	public function __construct()
	{
		...
		// Table object (t099_audittrail)
		if (!isset($GLOBALS["t099_audittrail"]) || get_class($GLOBALS["t099_audittrail"]) == PROJECT_NAMESPACE . "t099_audittrail") {
			$GLOBALS["t099_audittrail"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["t099_audittrail"];
		}
		...
		$this->AddUrl = "t099_audittrailadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "t099_audittraildelete.php";
		$this->MultiUpdateUrl = "t099_audittrailupdate.php";
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 't099_audittrail');
		...
		$this->FilterOptions->TagClassName = "ew-filter-option ft099_audittraillistsrch";
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "ft099_audittraillistsrch", $filters);
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"ft099_audittraillistsrch\" href=\"#\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"ft099_audittraillistsrch\" href=\"#\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.ft099_audittraillist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"ft099_audittraillistsrch\">" . $Language->phrase("SearchLink") . "</button>";
		$item->Visible = TRUE;
