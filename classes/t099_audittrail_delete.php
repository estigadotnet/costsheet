 ...
 * Page class
 */
class t099_audittrail_delete extends t099_audittrail
{
	...
	// Page object name
	public $PageObjName = "t099_audittrail_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t099_audittraillist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("t099_audittraillist.php"); // Return to list
			}
		}
	}
