 ...
 * Page class
 */
class t099_audittrail_view extends t099_audittrail
{
	...
	// Page object name
	public $PageObjName = "t099_audittrail_view";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			if (!$Security->canView()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("t099_audittraillist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "t099_audittraillist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t099_audittraillist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t099_audittraillist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("t099_audittraillist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
