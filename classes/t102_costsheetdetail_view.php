 ...
 * Page class
 */
class t102_costsheetdetail_view extends t102_costsheetdetail
{
	...
	// Page object name
	public $PageObjName = "t102_costsheetdetail_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "t102_costsheetdetaillist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t102_costsheetdetaillist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t102_costsheetdetaillist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
