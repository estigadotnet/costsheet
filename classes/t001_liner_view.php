 ...
 * Page class
 */
class t001_liner_view extends t001_liner
{
	...
	// Page object name
	public $PageObjName = "t001_liner_view";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			if (!$Security->canView()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("t001_linerlist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "t001_linerlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t001_linerlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t001_linerlist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("t001_linerlist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
