 ...
 * Page class
 */
class t102_costsheetdetail_delete extends t102_costsheetdetail
{
	...
	// Page object name
	public $PageObjName = "t102_costsheetdetail_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t102_costsheetdetaillist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("t102_costsheetdetaillist.php"); // Return to list
			}
		}
	}
