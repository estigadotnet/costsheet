 ...
 * Page class
 */
class t102_costsheetdetail_grid extends t102_costsheetdetail
{
	...
	// Page object name
	public $PageObjName = "t102_costsheetdetail_grid";

	// Grid form hidden field names
	public $FormName = "ft102_costsheetdetailgrid";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "t101_costsheethead") {
			$this->costsheethead_id->Visible = FALSE;
			if ($GLOBALS["t101_costsheethead"]->EventCancelled)
